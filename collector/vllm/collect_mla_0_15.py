...
def run_attention_torch(
    ...
    # v0.15.1+: Create vllm_config BEFORE get_attn_backend_cls()
    # MLA backend's supports_combination() requires get_current_vllm_config()
    if is_context_phase:
    ...
    # Now call get_attn_backend_cls() within vllm_config context
    with set_current_vllm_config(vllm_config):
        try:
            ...
            print(f"get_attn_backend_cls failed: {e}")
            raise
